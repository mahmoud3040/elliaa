            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div className="space-y-6 animate-slide-in-left">
                ...
                <div className="space-y-4 text-muted-foreground leading-relaxed">
                  <p>
                    بدأت رحلة متجر إيلياء من فكرة بسيطة: توفير أدوات مكتبية عالية الجودة 
                    بأسعار مناسبة لجميع شرائح المجتمع المصري. منذ تأسيسنا، نسعى لأن نكون 
                    الخيار الأول للطلاب والموظفين والشركات.
                  </p>
                  <p>
